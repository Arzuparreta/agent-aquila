...
AGENT_TOOL_DISPATCH: dict[str, tuple[str, bool]] = {
    ...
    "outlook_get_message": ("_tool_outlook_get_message", False),    "list_connectors": ("_tool_list_connectors", False),
    ...
    "telegram_send_message": ("_tool_telegram_send_message", False),    "device_list_ingested_files": ("_tool_device_list_ingested_files", False),
    "delete_memory": ("_tool_delete_memory", False),
    "list_memory": ("_tool_list_memory", False),
    "recall_memory": ("_tool_recall_memory", False),    "memory_get": ("_tool_memory_get", False),
    ...
    "propose_whatsapp_send": ("_tool_propose_whatsapp_send", True),    "propose_slack_post_message": ("_tool_propose_slack_post_message", True),
